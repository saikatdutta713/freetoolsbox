...
let EncodeToBase64 = () => {
    ...
    return (
        <>
            <Head>
                <title>Digitoolboxes - Convert Text To Base64 String</title>

                <meta name="viewport" content="initial-scale=1.0, width=device-width" />
                <meta name='description' content="Convert your text to base64 string.This Free online tool converts text in a very short time and Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                <meta name='robots' content="index, follow" />
                <meta name="keywords" content="text to base64,convert text to base64,text to base64 online,free" />

                <meta property="og:title" content="Convert Text To Base64 String - Freetoolsbox.com" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://freetoolsbox.com/tools/text-to-base64" />
                <meta property="og:site_name" content="freetoolsbox.com" />
                <meta property="og:description" content="Convert your text to base64 string.This Free online tool converts text in a very short time and Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                ...
                <meta name="twitter:title" content="Convert Text To Base64 String - Freetoolsbox.com" />
                <meta name="twitter:description" content="Convert your text to base64 string.This Free online tool converts text in a very short time and Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                <meta name="twitter:image" content="https://www.freetoolsbox.com/favicon/favicon-196x196.png" />
            </Head>
            <div className="mainContent">
                <Sidebar />
                <div className='content'>
                    <center><h3 className='pageTitle'>Convert Text To Base64 String</h3></center>
                    <center><span className='subTitle'>Convert Text to Base64 String easily</span></center>
                    <Base64Handler convert_from={'text'} />
                    <div className="faqs">
                        <h2 className="title"><u>Frequently Asked Questions</u></h2>
                        <div className="questionBox">
                            <h4 className="question">How do I convert text to base64?</h4>
                            <h5 className="answer">
                                <ol type="1">
                                    <li>Write/paste the text you want to Encode to base64.</li>
