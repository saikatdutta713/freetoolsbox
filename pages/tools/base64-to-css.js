...
let DecodeBase64 = () => {
    ...
    return (
        <>
            <Head>
                <title>Convert Base64 String To Css - Freetoolsbox.com</title>

                <meta name="viewport" content="initial-scale=1.0, width=device-width" />
                <meta name='description' content="Convert Base64 string to css source code.This Free online tool converts Base64 string to css source code in a very short time and you can Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                <meta name='robots' content="index, follow" />
                <meta name="keywords" content="base64 to css,convert base64 to css,base64 to css converter online,free" />

                <meta property="og:title" content="Convert Base64 string to css source code - Freetoolsbox.com" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://freetoolsbox.com/tools/base64-to-css" />
                ...
                <meta name="twitter:title" content="Convert Base64 string to css source code - Freetoolsbox.com" />
            ...
            <div className="mainContent">
                ...
                <div className='content'>
                    <center><h3 className='pageTitle'>Convert Base64 String To Css</h3></center>
                    <center><span className='subTitle'>Convert Base64 String to Css file  easily</span></center>
                    <Base64Handler convert_to={'css'} />
                    <div className='faqs'>
                        ...
                        <div className="questionBox">
                            ...
                            <h5 className="answer">
                                <ol type="1">
                                    <li>paste the base64 string that you want to convert to css source code.</li>
