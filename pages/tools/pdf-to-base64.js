...
let PdfToBase64 = () => {
    ...
    return (
        <>
            <Head>
                <title>Convert PDF File To Base64 String - Freetoolsbox.com</title>

                <meta name="viewport" content="initial-scale=1.0, width=device-width" />
                <meta name='description' content="Convert your PDF file to base64 string.This Free online tool converts pdf file in a very short time and Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                <meta name='robots' content="index, follow" />
                <meta name="keywords" content="pdf to base64,pdf to base64 online converter,pdf to base64 encoder online,free" />

                <meta property="og:title" content="Convert PDF File To Base64 String - Freetoolsbox.com" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://freetoolsbox.com/tools/pdf-to-base64" />
                <meta property="og:site_name" content="freetoolsbox.com" />
                <meta property="og:description" content="Convert your PDF file to base64 string.This Free online tool converts pdf file in a very short time and Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                ...
                <meta name="twitter:description" content="Convert your PDF file to base64 string.This Free online tool converts pdf file in a very short time and Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                <meta name="twitter:image" content="https://www.online-convert.com/favicon/favicon-196x196.png" />
            </Head>
            <div className="mainContent">
                <Sidebar />
                <div className='content'>
                    <center><h3 className='pageTitle'>Convert PDF To Base64 String</h3></center>
                    <center><span className='subTitle'>Convert PDF file to Base64 String easily</span></center>
                    <Base64Handler convert_from={'pdf'} />
                    <div className="faqs">
                        ...
                        <div className="questionBox">
                            ...
                            <h5 className="answer">
                                <ol type="1">
                                    <li>Choose the pdf file you want to Encode to base64.</li>
