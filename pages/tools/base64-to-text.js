...
let DecodeBase64 = () => {
    ...
    return (
        <>
            <Head>
                <title>Convert Base64 String To Text - Freetoolsbox.com</title>

                <meta name="viewport" content="initial-scale=1.0, width=device-width" />
                <meta name='description' content="Convert Base64 string to text.This Free online tool converts Base64 string to text in a very short time and you can Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                <meta name='robots' content="index, follow" />
                <meta name="keywords" content="base64 to text,convert base64 to text,base64 to text converter online,free" />

                <meta property="og:title" content="Convert Base64 string to text - Freetoolsbox.com" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://freetoolsbox.com/tools/base64-to-text" />
                <meta property="og:site_name" content="freetoolsbox.com" />
                <meta property="og:description" content="Convert Base64 string to text.This Free online tool converts Base64 string to text in a very short time and you can Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                ...
                <meta name="twitter:title" content="Convert Base64 string to text - Freetoolsbox.com" />
            ...
            <div className="mainContent">
                ...
                <div className='content'>
                    <center><h3 className='pageTitle'>Convert Base64 String To Text</h3></center>
                    <center><span className='subTitle'>Convert Base64 String to Text file  easily</span></center>
                    <Base64Handler convert_to={'text'} />
                    <div className='faqs'>
                        <h2 className="title"><u>Frequently Asked Questions</u></h2>
                        <div className="questionBox">
                            <h4 className="question">How do I convert Base64 string to text?</h4>
                            <h5 className="answer">
                                <ol type="1">
                                    <li>paste the base64 string that you want to convert to text.</li>
