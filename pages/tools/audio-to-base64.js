...
let EncodeToBase64 = () => {
    ...
    return (
        <>
            <Head>
                <title>Convert Audio File To Base64 String - Freetoolsbox.com</title>

                <meta name="viewport" content="initial-scale=1.0, width=device-width" />
                <meta name='description' content="Convert your audio file to base64 string.This Free online tool converts audio file in a very short time and Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                <meta name='robots' content="index, follow" />
                <meta name="keywords" content="audio to base64,convert audio to base64,audio to base64 encode online,free" />

                <meta property="og:title" content="Convert Audio File To Base64 String - Freetoolsbox.com" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://freetoolsbox.com/tools/audio-to-base64" />
                <meta property="og:site_name" content="freetoolsbox.com" />
                <meta property="og:description" content="Convert your audio file to base64 string.This Free online tool converts audio file in a very short time and Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                ...
                <meta name="twitter:title" content="Convert Audio File To Base64 String - Freetoolsbox.com" />
                <meta name="twitter:description" content="Convert your audio file to base64 string.This Free online tool converts audio file in a very short time and Download base64 string in a text file.This tool don't upload files to the server to convert, It process files at your side only so this tool is 100% secure!" />
                <meta name="twitter:image" content="https://www.freetoolsbox.com/favicon/favicon-196x196.png" />
            </Head>
            <div className="mainContent">
                <Sidebar />
                <div className='content'>
                    <center><h3 className='pageTitle'>Convert Audio To Base64 String</h3></center>
                    <center><span className='subTitle'>Convert Audio file to Base64 String easily</span></center>
                    <Base64Handler convert_from={'audio'} />
                    <div className="faqs">
                        <h2 className="title"><u>Frequently Asked Questions</u></h2>
                        <div className="questionBox">
                            <h4 className="question">How do I convert audio file to base64?</h4>
                            <h5 className="answer">
                                <ol type="1">
                                    <li>Choose the Audio file you want to Encode to base64.</li>
